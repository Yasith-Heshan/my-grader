...
# Add the project root to the path to access config
project_root = os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(__file__))))
sys.path.insert(0, project_root)

from config.database import get_db_manager, HomeworkDataManager, GradesDataManager, TestCaseManager
...
class LocalGrader:
    ...
    def __init__(self, homework_name: str, data_dir: str = "grader_data"):
        ...
        from ..database.factories.database_factory import DatabaseManagerFactory
