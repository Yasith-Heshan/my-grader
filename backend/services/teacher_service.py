...
async def create_single_cell_testcase(
    testcase_data: SingleCellTestCaseCreate,
) -> SingleCellTestCase:
    """
...
async def get_testcases_for_cell(
    assignment_id: str, cell_id: str
) -> List[SingleCellTestCase]:
